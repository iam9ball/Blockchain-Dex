...
const BIG_INT_300 = BigInt(300);
const BIG_INT_500 = BigInt(500);
const BIG_INT_1500 = BigInt(1500);
const BIG_INT_1000 = BigInt(1000);
...
export const PRICE_IMPACT_WITHOUT_FEE_CONFIRM_MIN: Percent = new Percent(BIG_INT_1000, BIPS_BASE) // 10%
